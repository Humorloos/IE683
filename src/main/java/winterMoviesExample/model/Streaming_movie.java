 ...
 * 
 */
public class Streaming_movie extends AbstractRecord<Attribute> implements Serializable {
	...
	public Streaming_movie(String identifier, String provenance) {
 ...
 public void setTags(List<String> tags) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof Streaming_movie){
			return this.getIdentifier().equals(((Streaming_movie) obj).getIdentifier());
		}else
			return false;
	}
