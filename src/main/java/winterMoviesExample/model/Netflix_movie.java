 ...
 * 
 */
public class Netflix_movie extends AbstractRecord<Attribute> implements Serializable {
	...
	public Netflix_movie(String identifier, String provenance) {
 ...
 public void setTags(List<String> tags) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof Netflix_movie){
			return this.getIdentifier().equals(((Netflix_movie) obj).getIdentifier());
		}else
			return false;
	}
